...
sub unify_long_spaces    { local $_ = shift; tr/\x{0020}/\x{0020}/s; tr/\x{3000}/\x{3000}/s; s/[\x{0020}\x{3000}]{2,}/\x{0020}/g; $_; }
sub trim                 { local $_ = shift; s/^\s+//gm; s/\s+$//gm; $_; }
sub ltrim                { local $_ = shift; s/^\s+//gm; $_; }
sub rtrim                { local $_ = shift; s/\s+$//gm; $_; }
sub nl2space             { local $_ = shift; s/\x{000D}\x{000A}/\x{0020}/g; tr/\x{000D}\x{000A}/\x{0020}/; $_; }
